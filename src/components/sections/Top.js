    ...
    >
      <div className="w-full flex flex-col space-y-6">
        <div className="flex flex-col items-baseline">
          ...
          <div className="text-6xl font-bold text-gray-800 dark:text-white opacity-90">
            Albert Sun.
          </div>
        </div>

        <div className="text-xl md:w-1/2 opacity-80">
          I'm a computer science student at UT Austin who loves game
          development, human centered computing, and frontend development.
        </div>
